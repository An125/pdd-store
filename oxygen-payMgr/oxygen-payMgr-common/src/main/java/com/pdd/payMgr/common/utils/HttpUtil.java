...
//	public static String post(String uriString, Map<String, String> params) throws Exception {
...
//	public static String post(String uriString, Map<String, String> params, String authorization) throws Exception {
//		URL url = new URL(uriString);
//		HttpURLConnection con = (HttpURLConnection) url.openConnection();
//		con.setDoOutput(true);
//		con.setDoInput(true);
...
//	public static String jpost(String uriString, Map<String, String> params) throws Exception {
//		URL url = new URL(uriString);
//		HttpURLConnection con = (HttpURLConnection) url.openConnection();
//		con.setDoOutput(true);
//		con.setDoInput(true);
