...
/**
 * 通知消息的参数类
 * 详细情况请见：https://docs.open.alipay.com/204/105301/
 * @author Wu.Liang
 * @Date 2018年3月5日
 */
public class AlipayNotifyParams implements Serializable{
	/**
	 * @auther Wu.Liang
	 * @Date 2018年3月5日
	 */
	private static final long serialVersionUID = 8104543265750455040L;
