...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wx7a4478b2180fa338";//微信开发平台应用id
	public static String APP_SECRET = "cbfd5da7fda96398cbb868330e58e732";//应用对应的凭证
	//应用对应的密钥
	...
	public static String PARTNER = "1487814122";//财付通商户号
	public static String PARTNER_KEY = "wxmypddjunlang888efb666znd6abc66";//商户号对应的密钥
