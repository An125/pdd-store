...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params) {
	   ...
	   /* if(params.get("sign") != null) {sign = params.get("sign");}
        ...
        String sWord = "responseTxt=" + responseTxt + "返回回来的参数：" + AlipayCore.createLinkString(params);
     ...
     * @return 生成的签名结果
     */
	static boolean getSignVeryfy(Map<String, String> Params, String sign) {
    ...
    */
    static String verifyResponse(String notify_id) {
