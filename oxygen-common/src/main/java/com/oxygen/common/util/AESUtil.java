...
/**
 * AES加解密工具类
 * Created by yangxy on 2017/2/5.
 * modify by Wu.Liang
 */
public class AESUtil {

    private static final String ENCODE_RULES = "oxygen";
    ...
    public static String AESDecode(String content) throws Exception {
        try {
            ...
            throw new RuntimeException("兄弟，配置文件中的密码需要使用AES加密，请使用com.oxygen.common.util.AESUtil工具类修改这些值！");
