...
import com.oxygen.upms.dao.mapper.*;
import com.oxygen.upms.dao.model.*;
import com.oxygen.upms.rpc.api.UpmsApiService;
import com.oxygen.upms.rpc.mapper.UpmsApiMapper;
...
/**
 * UpmsApiService实现
 * Created by yangxy on 2017/09/19.
 */
@Service
@Transactional
public class UpmsApiServiceImpl implements UpmsApiService {
     ...
     */
    @Override
    @Cacheable(value = "oxygen-upms-rpc-service-ehcache", key = "'selectUpmsPermissionByUpmsUserId_' + #upmsUserId")
     ...
     */
    @Override
    @Cacheable(value = "oxygen-upms-rpc-service-ehcache", key = "'selectUpmsRoleByUpmsUserId_' + #upmsUserId")
