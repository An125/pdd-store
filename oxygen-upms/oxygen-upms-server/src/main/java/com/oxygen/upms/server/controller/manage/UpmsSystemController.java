...
/**
 * Created by yangxy on 2017/9/14.
 */
@Controller
...
public class UpmsSystemController extends BaseController {
    ...
    public String index() {
        return "/manage/system/index.html";
    }
    ...
    public Object create(UpmsSystem upmsSystem) {
        ...
        upmsSystem.setCreateDate(time);
        upmsSystem.setOrders(time.getTime());
    ...
    @ResponseBody
    public Object update(@PathVariable("id") String id, UpmsSystem upmsSystem) {
        ComplexResult result = FluentValidator.checkAll()
                .on(upmsSystem.getTitle(), new LengthValidator(1, 20, "标题"))
                .on(upmsSystem.getName(), new LengthValidator(1, 20, "名称"))
                .doValidate()
