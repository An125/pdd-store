...
import com.oxygen.common.util.MD5Util;
import com.oxygen.common.validator.LengthValidator;
import com.oxygen.common.validator.NotNullValidator;
...
import com.oxygen.upms.rpc.api.*;
...
public class UpmsUserController extends BaseController {
    ...
    public String organization(@PathVariable("id") String id, ModelMap modelMap) {
        ...
        return "/manage/user/organization.html";
    }
    ...
    public String permission(@PathVariable("id") String id, ModelMap modelMap) {
        ...
        return "/manage/user/permission.html";
    }
    ...
    public String create() {
        return "/manage/user/create.html";
    }
    ...
    public Object create(UpmsUser upmsUser) {
        ...
        upmsUser.setCreateDate(DateTime.now());
    ...
    public String update(@PathVariable("id") String id, ModelMap modelMap) {
        UpmsUser user = upmsUserService.selectByPrimaryKey(id);
        modelMap.put("user", user);
        return "/manage/user/update.html";
    }
