...
public class UpmsOrganizationController extends BaseController {
    ...
    public String index() {
        return "/manage/organization/index.html";
    }
    ...
    public String create() {
        return "/manage/organization/create.html";
    }
    ...
    public Object create(UpmsOrganization upmsOrganization) {
        ...
        upmsOrganization.setCreateDate(time);
        upmsOrganization.setOrganizationId(SecureUtil.simpleUUID());
    ...
    public String update(@PathVariable("id") String id, ModelMap modelMap) {
        ...
        return "/manage/organization/update.html";
    }
